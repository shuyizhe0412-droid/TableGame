...
function getApiBaseUrl(env) {
    var urls = {
        production: 'https://boardgame-hub.onrender.com/api',
...
function getSupabaseUrl(env) {
    var urls = {
        production: 'https://theaenpzcmydorhsjquf.supabase.co',
...
function getSupabaseAnonKey(env) {
    var keys = {
        production: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRoZWFlbnB6Y215ZG9yaHNqcXVmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzkyNjM0MTcsImV4cCI6MjA5NDgzOTQxN30.r2sLp5nbpYzQRkeO6DmqlbcFGYOQ81UekxOm9S18O-g',

...
var QRUtils = (function() {
    ...
    var SITE_URL = 'https://boardgame-hub-deploy.pages.dev';
    var CARD_W = 300;
    var CARD_H = 400;
    var QR_SIZE = 180;
    var QR_Y = 30;
    ...
    function generateSiteQRCard() {
        ...
        return drawQRCard(canvas, SITE_URL, {
            title: '桌游AI教练',
            subtitle: '扫码开始学习桌游规则',
            urlText: 'boardgame-hub-deploy.pages.dev'
        });
    }
    ...
    function showImageForLongPress(canvas, filename) {
        try {
            ...
            var html = '<!DOCTYPE html><html lang="zh-CN"><head><meta charset="UTF-8">' +
                ...
                '<p style="color:#999;font-size:12px;margin-top:8px;">桌游AI教练 · boardgame-hub-deploy.pages.dev</p></body></html>';
